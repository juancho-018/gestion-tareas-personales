...
<body class="bg-gray-50 dark:bg-gray-950 text-gray-900 dark:text-gray-100 min-h-screen font-sans antialiased">
    <div class="max-w-2xl mx-auto px-4 py-16">
        ...
        <div class="bg-white dark:bg-gray-900 shadow-2xl shadow-gray-200/50 dark:shadow-none border border-gray-100 dark:border-gray-800 rounded-3xl p-10">
            {{-- PUT requiere method spoofing en formularios HTML --}}
            <form action="{{ route('tareas.update', $tarea) }}" method="POST" class="space-y-8">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
                        <label for="prioridad" class="block text-sm font-black uppercase tracking-widest text-gray-500 mb-3">Prioridad</label>
                ...
                <div>
                    <label class="block text-sm font-black uppercase tracking-widest text-gray-500 mb-3">Estado</label>
                    <label class="flex items-center gap-3 cursor-pointer w-fit">
                        ...
                        <span class="font-medium text-gray-700 dark:text-gray-300">Marcar como completada</span>
                    </label>
                </div>
